...
const Post = ({ post, setCurrentId }) => {
  ...
  return (
    ...
    <Card style={{width:"230px"}} className={classes.card} raised elevation={6} >
      ...
      {/* <ButtonBase className={classes.cardAction} onClick={openPost}> */}
        ...
        <CardContent>
          <Typography variant="body2" color="textSecondary" component="p" onClick={openPost}>{post.message}</Typography>
        </CardContent>
